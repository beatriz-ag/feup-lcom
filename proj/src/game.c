...
void set_display() {
  ...
  loading[2] = get_sprite((xpm_map_t) init2, 73, 381);
  display_init();
  loading[2]->pos_x += 20;
  printf("1\n");
}
...
void set_platforms() {
  ...
  platforms[3].pos_x = 373;
  platforms[3].pos_y = 507;
  platforms[3].width = 62;
  ...
  platforms[6].pos_x = 419;
  platforms[6].pos_y = 205;
  platforms[6].width = 62;

  platforms[8].pos_x = 488;
  platforms[8].pos_y = 160;
  platforms[8].width = 309;

  platforms[7].pos_x = 898;
  platforms[7].pos_y = 212;
  platforms[7].width = 254;
}
